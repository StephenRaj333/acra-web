...
export const LampContainer = ({
  ...
  gradientFromColor = "#FF0505",
  gradientToColor = "#FF6B35", 
}: { 
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[400px] flex-col items-center justify-center overflow-hidden bg-background w-full z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        <motion.div
          ...
          style={{
            backgroundImage: `conic-gradient(var(--conic-position), ${gradientFromColor}, transparent)`,
          }}
        ...
        <motion.div
          ...
          style={{
            backgroundImage: `conic-gradient(var(--conic-position), transparent, ${gradientToColor})`,
          }}
        ...
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full opacity-50 blur-3xl" style={{ backgroundColor: gradientFromColor }}></div>
        <motion.div
          initial={{ width: "8rem" }}
          ...
          style={{ backgroundColor: `${gradientFromColor}cc` }}
        ></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
